...
namespace Lame\TypeScript\Tests;

use Lame\TypeScript\TypeScriptGenerator;
...
class GeneratorTest extends TestCase
{
    ...
    public function it_works()
    {
        ...
        $this->assertTrue(str_contains($result, 'sub_category?: Lame.TypeScript.Tests.Models.Category | null;'));
